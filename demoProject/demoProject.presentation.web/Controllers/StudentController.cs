...
namespace demoProject.presentation.web.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Lastname,Firstname,EnrollmentDate")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Lastname,Firstname,EnrollmentDate")] StudentModel studentModel)
        {
            if (ModelState.IsValid)
            {
